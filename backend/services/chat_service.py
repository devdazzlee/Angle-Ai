...
async def save_chat_message(session_id: str, user_id: str, role: str, content: str, phase: str = None, metadata: dict = None):
    """Save chat message with enhanced metadata support"""
    chat_data = {
    ...
    supabase.from_("chat_history").insert(chat_data).execute()
